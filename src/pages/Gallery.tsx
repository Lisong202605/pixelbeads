...
export function Gallery() {
  ...
  const patterns = [
    { id: 1, title: 'Cute Cat', category: 'animals', beads: 240, colors: 8, likes: 156 },
    { id: 2, title: 'Mario', category: 'gaming', beads: 480, colors: 12, likes: 234 },
    { id: 3, title: 'Pikachu', category: 'anime', beads: 360, colors: 6, likes: 312 },
    { id: 4, title: 'Sunset', category: 'nature', beads: 600, colors: 15, likes: 189 },
    { id: 5, title: 'Heart', category: 'cute', beads: 120, colors: 4, likes: 98 },
    { id: 6, title: 'Dog', category: 'animals', beads: 320, colors: 10, likes: 145 },
    { id: 7, title: 'Link', category: 'gaming', beads: 520, colors: 14, likes: 267 },
    { id: 8, title: 'Totoro', category: 'anime', beads: 420, colors: 8, likes: 298 },
  ];
        ...
        {filteredPatterns.map((pattern) => (
          ...
          >
            ...
            <div className="aspect-square bg-gradient-to-br from-red-100 to-red-200 flex items-center justify-center">
              <Grid className="w-16 h-16 text-red-300" />
            </div>
